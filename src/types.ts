...
export interface Annotation { id: string; bookId: string; title: string; author?: string; page: number; pageLabel: string; chapter?: string; blockId: string; block: number; segment: number; seconds: number; originalText: string; text: string; context: string; comment: string; color: string; createdAt: number; updatedAt: number; deletedAt?: number }
